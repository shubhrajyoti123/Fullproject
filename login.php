...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
  ...
  <div class="container">
    ...
    <input type="text" name="username" id="password" placeholder="Enter Username"value="<?php if(isset($_COOKIE["user_login"])) { echo $_COOKIE["user_login"]; } ?>" required>
    ...
    <label>
      <input type="checkbox" checked="checked" name="remember"id="remember" <?php if(isset($_COOKIE["user_login"])) { ?>  <?php } ?>> Remember me
    </label>
  </div>
